...
Output exactly this shape (omit any optional field you do not need):
{
  ...
  "filters": [{ "column": "<column to filter on>", "in": [<values to keep>], "datePart": "day | weekday | month | quarter (optional, for a date column)" }],
